...
knitr::include_graphics('Img/DiagramaFlujoMetodologia.jpg')
```

### 5.1 Recopilación de la información

#### 5.1.1 Digitalización del plano de zonificación
...
#### 5.1.2 Variables hidrometeorológicas	
...
#### 5.1.3 Calidad del aire en Campo de Marte
...
#### 5.1.4 Procesamiento de imágenes satelitales

##### 5.1.4.1 Temperatura de la superficie
...
##### 5.1.4.3 Radiación a temperatura de brillo en grados Celsius
...
##### 5.1.4.4 Temperatura de brillo a temperatura de superficie
...
##### 5.1.4.5 Índice de vegetación de diferencia normalizada
...
##### 5.1.4.6 Emisividad superficial
